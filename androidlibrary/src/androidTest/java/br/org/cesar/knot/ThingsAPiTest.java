...
public class ThingsAPiTest extends AndroidTestCase {
    ...
    private static final String LOCAL_MESHBLU_WEB_SERVER = "http://knot-test.cesar.org.br:3000"; // Put the address of your server, for example: http://172.26.67.70:3000
    ...
    private static final String UUID_OWNER = "6e455b0d-3be1-4052-8ba4-99b270220000"; // Put the uuid of the Owner
    private static final String TOKEN_OWNER = "8449949da1e33c0949e53210bab6696eb9d9a4d3"; // Put the token of the Owner
    ...
    public void testGetDevicesList(){
        ...
        try {
            ...
            Log.v("Diego", "size = " + listOfDevice.size());

            for (TestImplThingDevice device : listOfDevice){
                Log.v("Diego", "token = " + device.getToken());
                Log.v("Diego", "uuid = " + device.getUuid());
                Log.v("Diego", "owner = " + device.getOwner());
                Log.v("Diego", "size = " + device.toString());
            }
